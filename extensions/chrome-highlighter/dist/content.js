...
`});return n}function Xe(e,t){let n=`${document.title}
...
`,$={stats:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>',export:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>',close:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',jump:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg>',note:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>',toggle:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"></path><circle cx="12" cy="12" r="3"></circle></svg>',empty:'<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>'};function tt(){Ee(),R()}function Ee(){let e=document.getElementById(q);if(!e){e=document.createElement("div"),e.id=q;let t=e.attachShadow({mode:"open"}),n=document.createElement("style");n.textContent=Nt,t.appendChild(n),document.body.appendChild(e)}return e}function Lt(e){let n=Ee().shadowRoot,o=n.querySelector(".zr-stats-toggle");o||(o=document.createElement("button"),o.className="zr-stats-toggle",o.onclick=ke,n.appendChild(o)),o.innerHTML=`
  ...
  `,l.appendChild(c),s.total>0){let p=document.createElement("div");p.className="zr-stats-bar-wrap";let f=document.createElement("div");f.className="zr-stats-bar",et.forEach(b=>{let v=s.byColor[b.key];if(v>0){let x=document.createElement("div");x.className="zr-stats-bar-segment",x.style.backgroundColor=b.color,x.style.flex=`${v}`,x.title=`${b.label}: ${v}`,f.appendChild(x)}}),p.appendChild(f);let w=document.createElement("div");w.className="zr-stats-legend",et.forEach(b=>{let v=s.byColor[b.key],x=document.createElement("div");x.className="zr-stats-legend-item",x.innerHTML=`
      ...
      `,w.appendChild(x)}),p.appendChild(w),l.appendChild(p)}n.appendChild(l);let d=document.createElement("div");d.className="zr-stats-list-container",d.innerHTML='<div class="zr-stats-list-header">\u9AD8\u4EAE\u5217\u8868</div>';let h=document.createElement("div");h.className="zr-stats-list",B.length===0?h.innerHTML=`
    ...
    `:B.forEach(p=>{let f=document.createElement("div");f.className="zr-stats-item";let w=document.createElement("div");w.className="zr-stats-indicator",w.style.backgroundColor=p.style.backgroundColor;let b=document.createElement("div");if(b.className="zr-stats-item-content",b.innerHTML=`<div class="zr-stats-item-text">${p.textContent||""}</div>`,p.dataset.note){let x=document.createElement("div");x.className="zr-stats-item-note",x.innerHTML=`${$.note} <span>${p.dataset.note}</span>`,b.appendChild(x)}let v=document.createElement("div");v.className="zr-stats-jump",v.innerHTML=$.jump,f.append(w,b,v),f.onclick=()=>{p.scrollIntoView({behavior:"smooth",block:"center"}),p.style.outline="2px solid var(--zr-blue, #3b82f6)",p.style.outlineOffset="2px",setTimeout(()=>{p.style.outline="none"},2e3),Ce()},h.appendChild(f)}),d.appendChild(h),n.appendChild(d),t.appendChild(n),P=!0}function Ce(){let e=document.getElementById(q);if(!e)return;let t=e.shadowRoot?.querySelector(".zr-stats-panel");t&&(t.classList.add("zr-panel-fade-out"),setTimeout(()=>{t.remove(),P=!1},200))}function R(){if(B=Array.from(document.querySelectorAll("[data-zr-highlight-id]")),Lt(B.length),P){let t=document.getElementById(q)?.shadowRoot?.querySelector(".zr-stats-panel");t&&(t.remove(),P=!1,nt())}}function $t(){let e={total:B.length,byColor:{yellow:0,blue:0,green:0,red:0},withNotes:0};return B.forEach(t=>{let n=t.getAttribute("data-zr-color")||"yellow";e.byColor[n]!==void 0&&e.byColor[n]++,t.dataset.note&&e.withNotes++}),e}function It(e){let n=document.getElementById(q)?.shadowRoot;if(!n)return;let o=document.createElement("div");o.className="zr-export-menu",[{icon:"\u{1F4DD}",text:"Markdown",action:()=>ee({format:"markdown",includeNotes:!0,groupByColor:!0})},{icon:"\u{1F4C4}",text:"\u7EAF\u6587\u672C",action:()=>ee({format:"text",includeNotes:!0,groupByColor:!0})},{icon:"\u{1F310}",text:"HTML",action:()=>ee({format:"html",includeNotes:!0,groupByColor:!0})},{type:"divider"},{icon:"\u{1F4CB}",text:"\u590D\u5236\u5BCC\u6587\u672C",action:Ve}].forEach(s=>{if(s.type==="divider"){let l=document.createElement("div");l.className="zr-export-divider",o.appendChild(l)}else{let l=document.createElement("div");l.className="zr-export-item",l.innerHTML=`<span>${s.icon}</span> <span>${s.text}</span>`,l.onclick=()=>{s.action(),o.remove()},o.appendChild(l)}});let i=e.getBoundingClientRect();o.style.top=`${i.bottom+8}px`,o.style.right=`${window.innerWidth-i.right}px`,n.appendChild(o);let a=s=>{o.contains(s.target)||(o.remove(),document.removeEventListener("mousedown",a))};setTimeout(()=>document.addEventListener("mousedown",a),0)}var rt="zr-settings-panel",it="zr-user-preferences",Se={highlightOpacity:60,highlightBorderStyle:"none",highlightBorderWidth:0,customColors:{yellow:y.yellow,blue:y.blue,green:y.green,red:y.red},highlightFontWeight:"normal",highlightFontStyle:"normal",highlightTextDecoration:"none",enableAnimations:!0,enableSounds:!1,shortcutsEnabled:!0,autoSave:!0},u={...Se},Te=!1;function at(){At(),Ne(),console.log("[Z-Reader] \u8BBE\u7F6E\u7CFB\u7EDF\u5DF2\u521D\u59CB\u5316")}function He(){if(Te)return;let e=document.createElement("div");e.className="zr-settings-backdrop",e.addEventListener("click",te);let t=document.createElement("div");t.id=rt,t.className="zr-settings-panel";let n=document.createElement("div");n.className="zr-settings-header";let o=document.createElement("h2");o.textContent="\u2699\uFE0F \u8BBE\u7F6E",n.appendChild(o);let r=document.createElement("button");r.className="zr-settings-close",r.innerHTML="\u2715",r.addEventListener("click",te),n.appendChild(r),t.appendChild(n);let i=document.createElement("div");i.className="zr-settings-content",i.appendChild(Ot()),i.appendChild(Pt()),i.appendChild(Bt()),i.appendChild(Rt()),t.appendChild(i);let a=document.createElement("div");a.className="zr-settings-footer";let s=document.createElement("button");s.className="zr-settings-btn zr-settings-btn-secondary",s.textContent="\u6062\u590D\u9ED8\u8BA4",s.addEventListener("click",Dt),a.appendChild(s);let l=document.createElement("button");l.className="zr-settings-btn zr-settings-btn-primary",l.textContent="\u4FDD\u5B58\u8BBE\u7F6E",l.addEventListener("click",()=>{st(),Ne(),te(),g.success("\u8BBE\u7F6E\u5DF2\u4FDD\u5B58")}),a.appendChild(l),t.appendChild(a),document.body.appendChild(e),document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("zr-settings-panel-show")}),Te=!0}function te(){let e=document.getElementById(rt),t=document.querySelector(".zr-settings-backdrop");e&&(e.classList.remove("zr-settings-panel-show"),setTimeout(()=>e.remove(),300)),t&&t.remove(),Te=!1}function Ot(){let e=document.createElement("div");e.className="zr-settings-section";let t=document.createElement("h3");t.className="zr-settings-section-title",t.textContent="\u{1F3A8} \u9AD8\u4EAE\u6837\u5F0F",e.appendChild(t);let n=ot("\u900F\u660E\u5EA6","highlightOpacity",0,100,u.highlightOpacity,l=>{u.highlightOpacity=l,S()});e.appendChild(n);let o=ne("\u8FB9\u6846\u6837\u5F0F","highlightBorderStyle",[{value:"none",label:"\u65E0\u8FB9\u6846"},{value:"solid",label:"\u5B9E\u7EBF"},{value:"dashed",label:"\u865A\u7EBF"},{value:"dotted",label:"\u70B9\u7EBF"}],u.highlightBorderStyle,l=>{u.highlightBorderStyle=l,S()});if(e.appendChild(o),u.highlightBorderStyle!=="none"){let l=ot("\u8FB9\u6846\u7C97\u7EC6","highlightBorderWidth",0,3,u.highlightBorderWidth,c=>{u.highlightBorderWidth=c,S()});e.appendChild(l)}let r=document.createElement("div");r.className="zr-settings-group";let i=document.createElement("label");i.className="zr-settings-label",i.textContent="\u81EA\u5B9A\u4E49\u989C\u8272",r.appendChild(i);let a=document.createElement("div");a.className="zr-settings-color-grid",Object.entries(u.customColors).forEach(([l,c])=>{let d=document.createElement("div");d.className="zr-settings-color-item";let h=document.createElement("input");h.type="color",h.value=c,h.addEventListener("change",f=>{u.customColors[l]=f.target.value,S()}),d.appendChild(h);let p=document.createElement("span");p.textContent=jt(l),d.appendChild(p),a.appendChild(d)}),r.appendChild(a),e.appendChild(r);let s=Mt();return e.appendChild(s),e}function Pt(){let e=document.createElement("div");e.className="zr-settings-section";let t=document.createElement("h3");t.className="zr-settings-section-title",t.textContent="\u270D\uFE0F \u5B57\u4F53\u6837\u5F0F",e.appendChild(t);let n=ne("\u5B57\u4F53\u7C97\u7EC6","highlightFontWeight",[{value:"normal",label:"\u6B63\u5E38"},{value:"bold",label:"\u52A0\u7C97"}],u.highlightFontWeight,i=>{u.highlightFontWeight=i,S()});e.appendChild(n);let o=ne("\u5B57\u4F53\u6837\u5F0F","highlightFontStyle",[{value:"normal",label:"\u6B63\u5E38"},{value:"italic",label:"\u659C\u4F53"}],u.highlightFontStyle,i=>{u.highlightFontStyle=i,S()});e.appendChild(o);let r=ne("\u6587\u672C\u88C5\u9970","highlightTextDecoration",[{value:"none",label:"\u65E0"},{value:"underline",label:"\u4E0B\u5212\u7EBF"}],u.highlightTextDecoration,i=>{u.highlightTextDecoration=i,S()});return e.appendChild(r),e}function Bt(){let e=document.createElement("div");e.className="zr-settings-section";let t=document.createElement("h3");t.className="zr-settings-section-title",t.textContent="\u2728 \u52A8\u753B\u548C\u6548\u679C",e.appendChild(t);let n=oe("\u542F\u7528\u52A8\u753B\u6548\u679C","enableAnimations",u.enableAnimations,r=>{u.enableAnimations=r});e.appendChild(n);let o=oe("\u542F\u7528\u58F0\u97F3\u53CD\u9988","enableSounds",u.enableSounds,r=>{u.enableSounds=r});return e.appendChild(o),e}function Rt(){let e=document.createElement("div");e.className="zr-settings-section";let t=document.createElement("h3");t.className="zr-settings-section-title",t.textContent="\u{1F527} \u5176\u4ED6\u8BBE\u7F6E",e.appendChild(t);let n=oe("\u542F\u7528\u952E\u76D8\u5FEB\u6377\u952E","shortcutsEnabled",u.shortcutsEnabled,r=>{u.shortcutsEnabled=r});e.appendChild(n);let o=oe("\u81EA\u52A8\u4FDD\u5B58\u9AD8\u4EAE","autoSave",u.autoSave,r=>{u.autoSave=r});return e.appendChild(o),e}function ot(e,t,n,o,r,i){let a=document.createElement("div");a.className="zr-settings-group";let s=document.createElement("label");s.className="zr-settings-label",s.htmlFor=t,s.textContent=e,a.appendChild(s);let l=document.createElement("div");l.className="zr-settings-slider-container";let c=document.createElement("input");c.type="range",c.id=t,c.className="zr-settings-slider",c.min=n.toString(),c.max=o.toString(),c.value=r.toString();let d=document.createElement("span");return d.className="zr-settings-slider-value",d.textContent=`${r}${o===100?"%":""}`,c.addEventListener("input",h=>{let p=parseInt(h.target.value);d.textContent=`${p}${o===100?"%":""}`,i(p)}),l.appendChild(c),l.appendChild(d),a.appendChild(l),a}function ne(e,t,n,o,r){let i=document.createElement("div");i.className="zr-settings-group";let a=document.createElement("label");a.className="zr-settings-label",a.htmlFor=t,a.textContent=e,i.appendChild(a);let s=document.createElement("select");return s.id=t,s.className="zr-settings-select",s.value=o,n.forEach(l=>{let c=document.createElement("option");c.value=l.value,c.textContent=l.label,l.value===o&&(c.selected=!0),s.appendChild(c)}),s.addEventListener("change",l=>{r(l.target.value)}),i.appendChild(s),i}function oe(e,t,n,o){let r=document.createElement("div");r.className="zr-settings-group zr-settings-checkbox-group";let i=document.createElement("input");i.type="checkbox",i.id=t,i.className="zr-settings-checkbox",i.checked=n,i.addEventListener("change",s=>{o(s.target.checked)});let a=document.createElement("label");return a.className="zr-settings-checkbox-label",a.htmlFor=t,a.textContent=e,r.appendChild(i),r.appendChild(a),r}function Mt(){let e=document.createElement("div");e.className="zr-settings-preview",e.id="zr-settings-preview";let t=document.createElement("div");t.className="zr-settings-preview-label",t.textContent="\u9884\u89C8\u6548\u679C",e.appendChild(t);let n=document.createElement("div");return n.className="zr-settings-preview-content",n.innerHTML=`
  ...
  `,e.appendChild(n),S(),e}function S(){let e=document.getElementById("zr-settings-preview");if(!e)return;e.querySelectorAll(".preview-highlight").forEach(n=>{let o=n,r=o.classList.contains("preview-yellow")?"yellow":o.classList.contains("preview-blue")?"blue":o.classList.contains("preview-green")?"green":"red";o.style.backgroundColor=u.customColors[r],o.style.opacity=(u.highlightOpacity/100).toString(),o.style.borderStyle=u.highlightBorderStyle,o.style.borderWidth=`${u.highlightBorderWidth}px`,o.style.borderColor=_(u.customColors[r],-20),o.style.fontWeight=u.highlightFontWeight,o.style.fontStyle=u.highlightFontStyle,o.style.textDecoration=u.highlightTextDecoration})}function At(){try{let e=localStorage.getItem(it);e&&(u={...Se,...JSON.parse(e)})}catch(e){console.error("[Z-Reader] \u52A0\u8F7D\u8BBE\u7F6E\u5931\u8D25:",e)}}function st(){try{localStorage.setItem(it,JSON.stringify(u))}catch(e){console.error("[Z-Reader] \u4FDD\u5B58\u8BBE\u7F6E\u5931\u8D25:",e),g.error("\u4FDD\u5B58\u8BBE\u7F6E\u5931\u8D25")}}function Ne(){let e=document.getElementById("zr-custom-styles")||document.createElement("style");e.id="zr-custom-styles";let{customColors:t,highlightOpacity:n,highlightBorderStyle:o,highlightBorderWidth:r,highlightFontWeight:i,highlightFontStyle:a,highlightTextDecoration:s}=u;e.textContent=`
  ...
  `,document.head.contains(e)||document.head.appendChild(e),u.enableAnimations?document.body.classList.remove("zr-no-animations"):document.body.classList.add("zr-no-animations")}function Dt(){confirm("\u786E\u5B9A\u8981\u6062\u590D\u6240\u6709\u8BBE\u7F6E\u4E3A\u9ED8\u8BA4\u503C\u5417\uFF1F")&&(u={...Se},st(),Ne(),te(),setTimeout(()=>He(),300),g.success("\u5DF2\u6062\u590D\u9ED8\u8BA4\u8BBE\u7F6E"))}function _(e,t){let n=parseInt(e.replace("#",""),16),o=Math.round(2.55*t),r=(n>>16)+o,i=(n>>8&255)+o,a=(n&255)+o;return"#"+(16777216+(r<255?r<1?0:r:255)*65536+(i<255?i<1?0:i:255)*256+(a<255?a<1?0:a:255)).toString(16).slice(1)}function jt(e){return{yellow:"\u9EC4\u8272",blue:"\u84DD\u8272",green:"\u7EFF\u8272",red:"\u7EA2\u8272"}[e]||e}var qt="ZReaderOffline",_t=1,lt="highlights",H="pending_operations",N=null,F=navigator.onLine,Ft=null;async function dt(){try{N=await Gt(),Wt(),Ut(),console.log("[Z-Reader] \u79BB\u7EBF\u652F\u6301\u5DF2\u521D\u59CB\u5316"),F||g.info("\u5F53\u524D\u5904\u4E8E\u79BB\u7EBF\u6A21\u5F0F\uFF0C\u6570\u636E\u5C06\u5728\u8054\u7F51\u540E\u540C\u6B65")}catch(e){console.error("[Z-Reader] \u521D\u59CB\u5316\u79BB\u7EBF\u652F\u6301\u5931\u8D25:",e)}}function Gt(){return new Promise((e,t)=>{let n=indexedDB.open(qt,_t);n.onerror=()=>t(n.error),n.onsuccess=()=>e(n.result),n.onupgradeneeded=o=>{let r=o.target.result;if(!r.objectStoreNames.contains(lt)){let i=r.createObjectStore(lt,{keyPath:"id"});i.createIndex("articleId","articleId",{unique:!1}),i.createIndex("synced","synced",{unique:!1})}r.objectStoreNames.contains(H)||r.createObjectStore(H,{keyPath:"id"}).createIndex("timestamp","timestamp",{unique:!1})}})}function Wt(){window.addEventListener("online",()=>{F=!0,g.success("\u5DF2\u6062\u590D\u7F51\u7EDC\u8FDE\u63A5\uFF0C\u5F00\u59CB\u540C\u6B65\u6570\u636E"),pt()}),window.addEventListener("offline",()=>{F=!1,g.warning("\u7F51\u7EDC\u5DF2\u65AD\u5F00\uFF0C\u5207\u6362\u5230\u79BB\u7EBF\u6A21\u5F0F")})}function Ut(){Ft=window.setInterval(()=>{F&&pt()},3e4)}async function Zt(){if(!N)throw new Error("Database not initialized");return new Promise((e,t)=>{let i=N.transaction([H],"readonly").objectStore(H).index("timestamp").getAll();i.onsuccess=()=>e(i.result),i.onerror=()=>t(i.error)})}async function ct(e){if(!N)throw new Error("Database not initialized");return new Promise((t,n)=>{let i=N.transaction([H],"readwrite").objectStore(H).delete(e);i.onsuccess=()=>t(),i.onerror=()=>n(i.error)})}async function Jt(e){if(!N)throw new Error("Database not initialized");return e.retries++,new Promise((t,n)=>{let i=N.transaction([H],"readwrite").objectStore(H).put(e);i.onsuccess=()=>t(),i.onerror=()=>n(i.error)})}async function pt(){if(!(!F||!N))try{let e=await Zt();if(e.length===0)return;console.log(`[Z-Reader] \u5F00\u59CB\u540C\u6B65 ${e.length} \u4E2A\u5F85\u5904\u7406\u64CD\u4F5C`);let t=0,n=0;for(let o of e)try{if(o.retries>=5){console.warn(`[Z-Reader] \u64CD\u4F5C ${o.id} \u91CD\u8BD5\u6B21\u6570\u8FC7\u591A\uFF0C\u8DF3\u8FC7`),await ct(o.id),n++;continue}await Kt(o),await ct(o.id),t++}catch(r){console.error("[Z-Reader] \u540C\u6B65\u64CD\u4F5C\u5931\u8D25:",o,r),await Jt(o),n++}t>0&&g.success(`\u5DF2\u540C\u6B65 ${t} \u4E2A\u64CD\u4F5C`),n>0&&g.warning(`${n} \u4E2A\u64CD\u4F5C\u540C\u6B65\u5931\u8D25\uFF0C\u5C06\u7A0D\u540E\u91CD\u8BD5`)}catch(e){console.error("[Z-Reader] \u540C\u6B65\u5931\u8D25:",e)}}async function Kt(e){let t="http://127.0.0.1:21897/api";switch(e.type){case"create":if(!(await fetch(`${t}/highlights`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e.data)})).ok)throw new Error("Create failed");break;case"update":if(!(await fetch(`${t}/highlights/${e.data.id}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(e.data)})).ok)throw new Error("Update failed");break;case"delete":if(!(await fetch(`${t}/highlights/${e.data.id}`,{method:"DELETE"})).ok)throw new Error("Delete failed");break}}var A=null;async function Vt(){at(),dt(),Je(),Xt(),tt();try{let e=await De(window.location.href);if(e.articleId){A=e.articleId;for(let t of e.highlights)se(t.id,t.text??"",t.color??"yellow",{startOffset:t.startOffset??void 0,endOffset:t.endOffset??void 0,paragraphIndex:t.paragraphIndex??void 0,note:t.note??void 0});R()}}catch{}}document.addEventListener("mouseup",()=>{let e=window.getSelection();!e||e.isCollapsed||!e.toString().trim()||requestAnimationFrame(()=>{let t=window.getSelection();if(!t||t.isCollapsed)return;let o=t.getRangeAt(0).getBoundingClientRect(),r=o.left+o.width/2+window.scrollX,i=o.top+window.scrollY;Me(r,i,async a=>{a.type==="highlight"?await M(a.color):a.type==="save"?await gt():a.type==="note"&&await $e()})})});async function Le(){if(A)return!0;try{return A=(await Ae({url:window.location.href,title:document.title})).id,!0}catch(e){return console.error("[Z-Reader] \u4FDD\u5B58\u6587\u7AE0\u5931\u8D25:",e),!1}}async function M(e){let t=ae(e);if(t){if(!await Le()){g.error("\u4FDD\u5B58\u6587\u7AE0\u5931\u8D25\uFF0C\u65E0\u6CD5\u521B\u5EFA\u9AD8\u4EAE");return}try{let n=await de({articleId:A,text:t.text,color:e,startOffset:t.startOffset,endOffset:t.endOffset,paragraphIndex:t.paragraphIndex});t.updateId(n.id),g.success("\u9AD8\u4EAE\u5DF2\u521B\u5EFA"),R()}catch(n){console.error("[Z-Reader] \u521B\u5EFA\u9AD8\u4EAE\u5931\u8D25:",n),g.error("\u521B\u5EFA\u9AD8\u4EAE\u5931\u8D25")}}}async function gt(){await Le()?g.success("\u6587\u7AE0\u5DF2\u4FDD\u5B58\u5230 Z-Reader"):g.error("\u4FDD\u5B58\u6587\u7AE0\u5931\u8D25")}async function $e(){let t=window.getSelection()?.toString().trim()||"";ue({selectedText:t,initialColor:"yellow",onSave:async(n,o,r)=>{let i=ae(o);if(i){if(!await Le()){g.error("\u4FDD\u5B58\u6587\u7AE0\u5931\u8D25\uFF0C\u65E0\u6CD5\u521B\u5EFA\u9AD8\u4EAE");return}try{let a=await de({articleId:A,text:i.text,note:n,color:o,startOffset:i.startOffset,endOffset:i.endOffset,paragraphIndex:i.paragraphIndex});i.updateId(a.id),le(a.id,n);for(let s of r)await he(a.id,s);g.success("\u7B14\u8BB0\u9AD8\u4EAE\u5DF2\u521B\u5EFA"),R()}catch(a){console.error("[Z-Reader] \u521B\u5EFA\u5E26\u7B14\u8BB0\u9AD8\u4EAE\u5931\u8D25:",a),g.error("\u521B\u5EFA\u7B14\u8BB0\u9AD8\u4EAE\u5931\u8D25")}}},onCancel:()=>{}})}document.addEventListener("zr-highlight-click",e=>{let t=e.detail;if(!t?.id||!t.element)return;let o=t.element.getBoundingClientRect(),r=o.left+window.scrollX,i=o.bottom+window.scrollY+5;We({x:r,y:i,highlightId:t.id,note:t.note,onDelete:()=>{Oe(t.id),je(t.id).then(()=>{g.success("\u9AD8\u4EAE\u5DF2\u5220\u9664"),R()}).catch(a=>{console.error("[Z-Reader] \u5220\u9664\u9AD8\u4EAE\u5931\u8D25:",a),g.error("\u5220\u9664\u9AD8\u4EAE\u5931\u8D25")})},onEditNote:async()=>{let a=[];try{a=await ge(t.id)}catch(s){console.error("Failed to fetch highlight tags:",s)}ue({highlightId:t.id,initialNote:t.note,selectedText:t.text,initialColor:t.color,initialTags:a,onSave:async(s,l,c)=>{try{await pe(t.id,{note:s,color:l}),le(t.id,s),Pe(t.id,l);let h=(await ge(t.id)).map(p=>p.id);for(let p of h)c.includes(p)||await Fe(t.id,p);for(let p of c)h.includes(p)||await he(t.id,p);g.success("\u7B14\u8BB0\u5DF2\u66F4\u65B0")}catch(d){console.error("[Z-Reader] \u66F4\u65B0\u7B14\u8BB0\u5931\u8D25:",d),g.error("\u66F4\u65B0\u7B14\u8BB0\u5931\u8D25")}},onCancel:()=>{}})},onChangeColor:async a=>{try{await pe(t.id,{color:a});let s=document.querySelector(`[data-zr-highlight-id="${t.id}"]`);s&&(s.style.backgroundColor=Yt(a)),g.success("\u989C\u8272\u5DF2\u66F4\u6539")}catch(s){console.error("[Z-Reader] \u66F4\u6539\u989C\u8272\u5931\u8D25:",s),g.error("\u66F4\u6539\u989C\u8272\u5931\u8D25")}},onCopy:()=>{navigator.clipboard.writeText(t.text).then(()=>{g.success("\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F")}).catch(()=>{g.error("\u590D\u5236\u5931\u8D25")})}})});function Yt(e){return y[e]||y.yellow}chrome.runtime.onMessage.addListener(e=>{if(e.type==="ARTICLE_SAVED"&&(A=e.payload.id),e.type==="HIGHLIGHT_SELECTION"){let t=e.payload.color||"yellow";M(t)}if(e.type==="HIGHLIGHT_WITH_NOTE"&&$e(),e.type==="SHOW_TOAST"){let{message:t,type:n}=e.payload;n==="success"?g.success(t):n==="error"?g.error(t):n==="warning"?g.warning(t):g.info(t)}if(e.type==="SEARCH_IN_ZREADER"){let t=e.payload.text;g.info(`\u641C\u7D22\u529F\u80FD\u5F00\u53D1\u4E2D: "${t}"`)}});function Xt(){E({key:"1",alt:!0,description:"\u9EC4\u8272\u9AD8\u4EAE",category:"\u9AD8\u4EAE\u64CD\u4F5C",action:()=>M("yellow")}),E({key:"2",alt:!0,description:"\u84DD\u8272\u9AD8\u4EAE",category:"\u9AD8\u4EAE\u64CD\u4F5C",action:()=>M("blue")}),E({key:"3",alt:!0,description:"\u7EFF\u8272\u9AD8\u4EAE",category:"\u9AD8\u4EAE\u64CD\u4F5C",action:()=>M("green")}),E({key:"4",alt:!0,description:"\u7EA2\u8272\u9AD8\u4EAE",category:"\u9AD8\u4EAE\u64CD\u4F5C",action:()=>M("red")}),E({key:"n",alt:!0,description:"\u6DFB\u52A0\u7B14\u8BB0\u9AD8\u4EAE",category:"\u9AD8\u4EAE\u64CD\u4F5C",action:$e}),E({key:"s",alt:!0,description:"\u4FDD\u5B58\u6587\u7AE0\u5230 Z-Reader",category:"\u6587\u7AE0\u64CD\u4F5C",action:gt}),E({key:"h",alt:!0,description:"\u5207\u6362\u9AD8\u4EAE\u7EDF\u8BA1\u9762\u677F",category:"\u9762\u677F\u64CD\u4F5C",action:ke}),E({key:",",alt:!0,description:"\u6253\u5F00\u8BBE\u7F6E\u9762\u677F",category:"\u9762\u677F\u64CD\u4F5C",action:He}),E({key:"?",alt:!0,description:"\u663E\u793A\u5FEB\u6377\u952E\u5E2E\u52A9",category:"\u5E2E\u52A9",action:Ke}),console.log("[Z-Reader] \u5DF2\u6CE8\u518C 9 \u4E2A\u5FEB\u6377\u952E")}Vt();})();
